...
**Вpемя:** Интерпретация кода.
**Доступность:** Нужно скачать NodeJS или использовать в браузере.  
**Hадежность:** 100%, самый лучший способ.  
**Пpимечания:** Включи видео-урок по JS/TS и начни писать код.  
...
## Самоампутирование головы с помощью машины
